 ...
 * @author tp4768
 *
 *         class that extends JPanel, and displays the game mode menu. Based on
 *         GameModes enum.
 */
public class GameModeMenu extends JPanel {
     ...
     * Action Handling is done in a seperate class but keep in mind that we pass the
     * parent JFrame to the action handler
     * in order to be able to close the parent frame. when the user clicks on a
     * button.
     */
